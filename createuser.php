...
<?php
    ...
    $sql="insert into users(name,age,email,account,balance) values('{$name}','{$age}','{$email}','{$account}','{$balance}')";
...
?>
        ...
        <h2 class="text-center pt-4" style="color : blue;">New User</h2>
        <br>
      ...
      <div class="screen-body">
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group">
            <input class="app-form-control" placeholder="Account number" type="number" name="account" id="account" required>
            </div>
